...
Estado do trabalho fica em .ply/tasks/*.md, lido sob demanda via ./ply.
...
3. ./ply brief `<id>`        — leia SÓ isto; abra .ply/specs/ apenas se o AC não bastar
4. ./ply start `<id>`
...
- Início de sessão: tail -20 .ply/tasks/LESSONS.md (se existir).
